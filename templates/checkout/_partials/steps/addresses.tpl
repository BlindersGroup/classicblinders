...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {if !$use_same_address}
        <h2 class="h4 title_address title_address_shipping">{l s='Shipping Address' d='Shop.Theme.Checkout'}</h2>
      {/if}
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><i class="fa-solid fa-plus"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        <h2 class="h4 title_address">{l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h2>

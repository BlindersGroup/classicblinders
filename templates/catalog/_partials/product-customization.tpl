...
<section class="product-customization">
  {if !$configuration.is_catalog}
    <div class="card">
      <p class="detalle card-title"><i class="fa-solid fa-circle-info"></i> {l s='Product customization' d='Shop.Theme.Catalog'}</p>
            ...
            {foreach from=$customizations.fields item="field"}
              <li class="product-customization-item">
                ...
                {if $field.type == 'text'}
                  ...
                  <small class="text_small">{l s='250 char. max' d='Shop.Forms.Help'}</small>
                  {if $field.text !== ''}
                ...
                {elseif $field.type == 'image'}
                  ...
                  <small class="text_small">{l s='.png .jpg .gif' d='Shop.Forms.Help'}</small>
                {/if}
              </li>
            {/foreach}
          </ul>
          <div class="clearfix">
            <button class="btn btn-secondary btn_personalizacion" type="submit" name="submitCustomizedData">{l s='Save Customization' d='Shop.Theme.Actions'}</button>
          </div>
        </form>
      {/block}
